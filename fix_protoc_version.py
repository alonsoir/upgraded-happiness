...
def check_project_structure():
    ...
    expected_files = [
        "protocols/v3.1/network_security_clean_v31.proto",
        "protocols/v3.1/firewall_commands_v31.proto",
        "protocols/v3.1/__init__.py",
...
def check_file_contents():
    ...
    init_file = Path("protocols/v3.1/__init__.py")
    if init_file.exists():
    ...
    pb2_file = Path("protocols/v3.1/network_security_clean_v31_pb2.py")
    if pb2_file.exists():
