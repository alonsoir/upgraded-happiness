...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    3,
    "",
    "src/protocols/protobuf/network_event.proto",
)
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "src.protocols.protobuf.network_event_pb2", _globals
)
if not _descriptor._USE_C_DESCRIPTORS:
    DESCRIPTOR._loaded_options = None
    _globals["_NETWORKEVENT"]._serialized_start = 63
    _globals["_NETWORKEVENT"]._serialized_end = 288
