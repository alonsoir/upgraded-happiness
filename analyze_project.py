...
class ProjectAnalyzer:
    ...
    def _scan_files(self):
        ...
        for file_path in self.project_root.rglob("*.py"):
            ...
            elif file_path.name in ['system_orchestrator.py', 'lightweight_ml_detector.py']:
    ...
    def _analyze_fix_scripts(self):
        ...
        for script_path in self.analysis['fix_scripts']:
            ...
            try:
                ...
                imports = re.findall(r'import (\w+)', content) + re.findall(r'from (\w+) import', content)
    ...
    def _analyze_duplicates(self):
        ...
        all_files = self.analysis['python_files'] + self.analysis['essential_files'] + self.analysis['fix_scripts']
