...
if __name__ == "__main__":
    ...
    async def main():
        ...
        try:
            ...
            if not await setup_ml_detector_crypto(config_file, testing_mode=dev_mode):
                print("❌ Failed to setup ETCD crypto")
                if not dev_mode:
                    print("❌ ETCD crypto is MANDATORY - component SHUTDOWN")
                    return
            ...
            if not pipeline_key:
                ...
                if not dev_mode:
                    print("❌ Pipeline key is MANDATORY - component SHUTDOWN")
                    return
